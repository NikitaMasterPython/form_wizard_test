...
async def cmd_start_2(message: Message):
    await message.answer("1.Для подготовки документов обратитесь к боту с запросом «Шаблоны». \n \n "
                         "2. Выберете подходящий шаблон и отправьте соответствующее голосовое или текстовое сообщение. \n"
                         "Например, при необходимости подготовки заявления на служебный автомобиль запрос должен содержать следующий текст: \n \n "
                         "Подготовь заявление на служебный автомобиль на 20.09.2025 на Иванова Ивана Ивановича. \n \n "
                         "Подготовь заявление на оплату расходов к месту проведения отдыха на 15000 рублей на Петрова Петра Николаевича \n \n "
                         "Подготовь заявление на офисную бумагу в отдел кадров от Петрова Петра Петровича. \n \n"
                         "Подготовь документальное уведомление, 20.03.2025 на территории организации запланированы ремонтные работы \n \n "
                         "Подготовь служебную записку на доставку бетомешалка-200 по адресу: г. Хабаровск, ул. Пионерская, д.20 от И.И. Иванова \n \n "
                         "Подготовь служебную записку на списание пылесос-А500, Иванов Иван Иванович \n \n "
