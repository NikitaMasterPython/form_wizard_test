...
async def show_templates(message: Message):
    ...
    await message.answer(
        ...
        "Сейчас я отправлю вам все шаблоны. Вы можете переслать нужные мне для добавления в базу данных.",
...
async def add_template(message: Message):
    await message.answer(
        ...
        "При подготовке своего шаблона особое внимание уделить параметрам {{}}, которые нужно заменять.\n"
